  ...
  return (
    <nav>
        <div className='logo-container'>
            { minimal ? (
                // These styles are taken from the tinder website by inspecting the code and copying the paths that are defined
                <svg className='logo' viewBox='0 0 519 123'>
        ...
        {!authToken && <button className='login-button' onClick={handleClick} disabled={showModal}>Log in</button>}
    </nav>
  )
}
